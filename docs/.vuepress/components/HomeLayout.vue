        ...
        <div class="container">
          <div class="hero__content">
            <div class="hero__content__inner" id="navConverter">
              ...
              <a href="https://godspen.ymm56.com/admin/#/home" class="button button__accent">开始使用</a>
              <div class="button button__accent home_video" @click="playVideo">
                <div>&nbsp</div>
              </div>
              <a href="https://github.com/ymm-tech/gods-pen" class="button hero__button">
                <svg
                  class="github"
              ...
              <a href="https://gitee.com/ymm-tech/gods-pen" class="button hero__button">GITEE</a>
...
"
                class="hero__text"
              >满帮大前端营销团队招人了，一起来做码良，一起玩转营销，目前组内8个人 ，团队氛围非常好，计划增加到12人，欢迎技术强，有担当的兄弟姐妹加入，坐标南京 主要技术栈vue，有兴趣的可将简历发给到 kunming.wangkm@amh-group.com 。谢谢！</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Expanded sections -->
    <div class="expanded landing__section" v-for="(value,key) in contentPart">
      <div class="container">
        <div class="expanded__inner">
          <div class="expanded__media">
            <img :src="value.img" class="expanded__image" />
          </div>
